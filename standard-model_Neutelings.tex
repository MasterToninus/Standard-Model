%+----------------------------------------------------------------------------+
%| Main-File: standard-model-Neutelings.tex
%| Contents:  Table of the Standard Model of Particle Physics with highlighted 
...
%|
%| Description: 
%|   This file contains a LaTeX table of the Standard Model (SM) of Particle 
%|   Physics, with different particle groups highlighted using opacity for 
%|   improved visualization during presentations.
%|
%| Inspired by: 
